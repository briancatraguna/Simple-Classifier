...
if __name__ == "__main__":
    ...
    dataset = SplitterDatasetFactory.create_instance(dataset_name, test_size=test_size)
    classifier = ClassifierFactory.create_instance(classifier_name, dataset=dataset)
